...
class Quotes extends Admin_Controller
{
    ...
    public function view($quote_id)
    {
        ...
        $this->layout->set(
            array(
                ...
                'quote_statuses' => $this->mdl_quotes->statuses(),
                'techpersons' => $this->mdl_persons->allpersons(),
                'salespersons' => $this->mdl_persons->allpersons(),                
            )
        );
    ...
    public function delete($quote_id, $quote_url_key = '')
    {
        // Delete the quote
        $this->load->model('upload/mdl_uploads');
        $this->mdl_quotes->delete($quote_id);
        $this->mdl_uploads->delete_by_key($quote_url_key);
     ...
     * giordo start
     */
    public function ggenerate_pdf($quote_id, $quote_template = "default", $direction = "" )
    {
        ...
        ggenerate_quote_pdf($quote_id, TRUE, $quote_template, FALSE, $direction);        
    }       
