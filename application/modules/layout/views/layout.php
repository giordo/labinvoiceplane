...
<!--[if lt IE 7]>
<html class="no-js ie6 oldie" lang="en"  ng-app="ui.bootstrap.demo"> <![endif]-->
<!--[if IE 7]>
<html class="no-js ie7 oldie" lang="en"  ng-app="ui.bootstrap.demo"> <![endif]-->
<!--[if IE 8]>
<html class="no-js ie8 oldie" lang="en" ng-app="ui.bootstrap.demo"> <![endif]-->
<!--[if gt IE 8]><!-->
<html class="no-js" lang="en" ng-app="ui.bootstrap.demo"> <!--<![endif]-->
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/default/css/base.css">
    ...
    <!--[if lt IE 9]>
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/default/css/jquery.ui.1.10.3.ie.css">
    <![endif]-->
    ...
    <script src="<?php echo base_url(); ?>assets/default/js/libs/jquery-ui.min.js"></script>
    -->
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
    <script src="https://code.jquery.com/ui/1.11.0/jquery-ui.js"></script>

    <script src="<?php echo base_url(); ?>assets/default/js/libs/bootstrap-3.3.2.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/default/js/libs/jquery.tabledit.js"></script>
    ...
    <link href="<?php echo base_url(); ?>assets/default/g2/css/css_tree-control.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/default/g2/css/css_style.css" rel="stylesheet">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('.create-destination').click(function () {
                ...
                $('#modal-placeholder').load("<?php echo site_url('destinations/ajax/modal_create_destination'); ?>");
            });
            ...
            $('.client-create-destination').click(function () {
                $('#modal-placeholder').load("<?php echo site_url('destinations/ajax/modal_create_destination'); ?>", {
                    client_id: $(this).data('client_id')
                });
            });
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="ip-navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><?php echo anchor('users/form/'.$this->session->userdata('user_id'), '<i class="fa fa-user"></i><span class="hidden-sm" >'.$this->session->userdata('user_name')).'</span>'; ?></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><?php echo anchor('persons/index', lang('persons')); ?></li>
