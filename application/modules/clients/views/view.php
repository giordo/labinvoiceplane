...
<div id="headerbar">
    ...
    <div class="pull-right btn-group">
        <a href="#" class="btn btn-sm btn-default client-create-destination"
           data-client-name="<?php echo $client->client_name; ?>">
            <i class="fa fa-file"></i> <?php echo lang('add_destination'); ?>
        </a>
...
<ul id="settings-tabs" class="nav nav-tabs nav-tabs-noborder">
    ...
    <li><a data-toggle="tab" href="#clientDestinations"><?php echo lang('destinations'); ?></a></li>
...
<div class="tabbable tabs-below">
    ...
    <div class="tab-content">
        ...
        <div id="clientDestinations" class="tab-pane table-content">
            <?php echo $destination_table; ?>
        </div>
