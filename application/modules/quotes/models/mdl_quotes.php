...
class Mdl_Quotes extends Response_Model
{
    ...
    public function default_join()
    {
        ...
        $this->db->join('ip_persons as sp', 'sp.person_id = ip_quotes.salesperson_id', 'left');
        $this->db->join('ip_persons as tp', 'tp.person_id = ip_quotes.techperson_id', 'left');
    }
    ...
    public function validation_rules()
    {
        return array(
            ...
            'techperson_id' => array(
                'field' => 'techperson_id',
                'label' => lang('techperson'),
                'rule' => ''
            ),
            'salesperson_id' => array(
                'field' => 'salesperson_id',
                'label' => lang('salesperson'),
                'rule' => ''
            ),
            'quoteref_id' => array(
                'field' => 'quoteref_id',
